...
public class UDPClient {
    ...
    public static void main(String[] args) throws Exception{
        ...
        ReadMessage readMessage = new ReadMessage(port, inetAddress, clientSocket, chatHistory);
        WriteMessage writeMessage = new WriteMessage(inetAddress, port, clientSocket, chatHistory);
        readMessage.start();
        writeMessage.start();
        writeMessage.join();
    }
